...
print(type);
  ...
  builder: (context, state) {
    return
      ...
      CountryCubit.get(context).cityModel  == null ?
                  ...
                  SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          translateString("Don't know the address? Add the recipient's number and we will receive it", 'لا تعرف العنوان ؟ أضف رقم المستلم وسنحصل عليه'),
                          style: TextStyle(
                              color: Colors.black,
                              fontFamily:
                              (lang == 'en') ? 'Nunito' : 'Almarai',
                                  ...
                                  //  width: 0.42*w,
                                   // height: 7*h,
                                    decoration: BoxDecoration(
                                        color: const Color(0xffE9E9E9),
                                        borderRadius: BorderRadius.circular(10),
                                        border: Border.all(color: selected2 == index ? Colors.black: Colors.transparent)
                                    ),
                                    child: Center(child: Text(
                                      translateString(CountryCubit.get(context).cityModel!.data![index].nameEn!, CountryCubit.get(context).cityModel!.data![index].nameAr!),
                                      maxLines: 1,

                                      style: selected2 == index ? TextStyle(color: mainColor,fontWeight: FontWeight.w100,) : TextStyle(color: Colors.black,fontWeight: FontWeight.w100,),)),
                                  ),
                                ),
                              );
                            },
